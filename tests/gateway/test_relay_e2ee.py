"""Known-answer tests for ``gateway.crypto.relay_e2ee``.
...
# production AAD helpers — the exact code path that runs on a real phone⇄agent link.
#
# CANONICAL CONTRACT (the BurnBar relay wire format):
