...
vectors the Python relay-crypto suite opens:
  ...
  * ``tests/gateway/fixtures/relay_wire_vector.json``   (v1 realtime relay)
  * ``tests/gateway/fixtures/gateway_wire_vector.json`` (v2 authenticated gateway)
...
RELAY_VECTOR_PATH = _FIXTURES / "relay_wire_vector.json"
GATEWAY_VECTOR_PATH = _FIXTURES / "gateway_wire_vector.json"
